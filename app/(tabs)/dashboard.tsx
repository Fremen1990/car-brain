			...
			<ScrollView contentContainerStyle={{ padding: 16 }}>
				...
				<View className="flex-row items-center bg-gradient-to-r from-[#1E1E2C] to-[#232533] rounded-xl p-4 mb-6 shadow-lg w-full justify-center">
					...
					<View className="p-3 rounded-xl bg-[#2A2A3D]">
						<Text className="text-[#FFA001] text-2xl font-bold">Hi, {user.username}!</Text>
						<Text className="text-[#CDCDE0] text-base">Welcome back to Car Brain.</Text>
					</View>
				</View>

				{/* Average Fuel Consumption and Mileage Overview */}
				<View className="bg-[#232533] rounded-xl p-4 mb-6">
					<Text className="text-[#FFA001] text-2xl font-bold">Your Vehicles</Text>
					<Text className="text-[#CDCDE0] text-base mt-2">
						Current average fuel consumption: {vehicle.avgFuelConsumption} L/100km
					</Text>
					<Text className="text-[#CDCDE0] text-base mt-2">Total mileage: {vehicle.mileage} miles</Text>
					...
					<View className="mt-4">
						...
						>
							<Text className="text-black text-lg font-semibold mr-2">View All Vehicles</Text>
				...
				<View className="bg-[#232533] rounded-xl p-4 mb-6">
					<Text className="text-white text-lg font-bold mb-4">Fuel Efficiency</Text>
					<LineChart
				...
				<View className="bg-[#232533] rounded-xl p-4 mb-6">
					<Text className="text-white text-lg font-bold mb-4">Recent Activities</Text>
					...
					<View className="mt-4">
						<Pressable
							...
							className="flex-row items-center justify-center bg-[#FFA001] py-2 px-4 rounded-lg shadow-md"
						>
							<Text className="text-black text-lg font-semibold mr-2">View Full History</Text>
							<Ionicons name="arrow-forward-circle" size={24} color="black" />
						</Pressable>
					</View>
				</View>
				...
				<View className="bg-[#232533] rounded-xl p-4 mb-6">
					<Text className="text-white text-lg font-bold mb-4">Maintenance Breakdown</Text>
					<PieChart
